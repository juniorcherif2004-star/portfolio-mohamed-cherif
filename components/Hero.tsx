        ...
        >
          ...
          >
            <a
              ...
              className="p-3 rounded-full bg-white dark:bg-secondary-800 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
            >
          ...
          >
            <svg 
              className="w-6 h-6 mx-auto text-secondary-400 dark:text-secondary-600" 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
