...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: "Premier projet web important consistant à créer un site vitale pour une petite entreprise. Utilisation de HTML5 sémantique, CSS3 avec Flexbox/Grid, et JavaScript vanilla pour l'interactivité. J'ai appris les bases du développement web et les principes du responsive design.",
